...
int main(int argc, char *argv[]) {
    ...
    if (array_is_sorted(playlist, length)) {
        printf("La playlist está ordenada\n");
    } else {
        printf("La playlist no está ordenada\n");
    }

    /* check if it is odd-sorted and show message */
    if (array_is_odd_sorted(playlist, length)) {
        printf("La playlist está imparmente ordenada\n");
    } else {
        printf("La playlist no está imparmente ordenada\n");
    }
